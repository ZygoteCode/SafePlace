...
public class SecurityUtils
{
    ...
    {
        string properties = Program.Base64Decode(superProperties);
    ...
    {
        string identity = Program.Base64Decode(discordIdentity);
    ...
    public static string CheckAndGetBrowser(string browserInformations, string discordIdentity, string userAgent, string sec_ch_ua, string browserValidity, string browserIdentification, string browserProperties)
    {
        ...
        string browser = "NULL", informations = Program.Base64Decode(browserInformations);
        ...
        string validity = Program.Base64Decode(browserValidity);
        ...
        else if (browserID >= 940000000000000000L && browserID <= 950000000000000000L)
        {
            realBrowserName = "Firefox";
        }
        else if (browserID >= 960000000000000000L && browserID <= 970000000000000000L)
        {
        ...
        {
            realBrowserName = "NULL";
        }

        browser = realBrowserName;
        ...
        string theProperties = Program.Base64Decode(browserProperties);
        ...
        string deviceUUID = Program.Base64Decode((string)j_uproperties.u);
        ...
        string identification = Program.Base64Decode(browserIdentification);
    ...
    public static Tuple<bool, string> CheckBody(string body)
    {
        dynamic jss = JObject.Parse(body);

        if (!JSONUtils.IsJsonOrderValid(body, new string[] { "mp", "sw", "sh", "st", "et", "ul", "al" }))
        {
        ...
        string pageURL = jss.ul, pageMD5 = jss.al;

        if (pageMD5 != CryptoUtils.GetMD5("KJNERKJHEWRKJHRWEKJWERHKJEWRHKJWERHKWERJHKRWEHJWERKJHKRWEJH" + pageURL + "KERJEHJKERWHKWERJHKJEWRHKWEJRHEWKJRHEWKJRHWERJKHWERKJHERJKHWERKJH"))
        {
            return new Tuple<bool, string>(false, "");
        }
        ...
        return new Tuple<bool, string>(true, verificationCode);
    }
}
